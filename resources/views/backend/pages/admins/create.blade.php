                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Admins Create</h4>
                ...
                <div class="main-content-inner">
                    <div class="row">
                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Admin Create</h4>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 com-sm-12">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Type Admin Name">
                                        </div>
                                        <div class="form-group col-md-6 com-sm-12">
